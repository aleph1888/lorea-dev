...
rhizomatik_elgg_plugins = ( 
    ...
    'sitemetas', 'spotlight_lorea', 'subgroups', 'suicide', 'tasks',
    'theme_ald', 'theme_n1', 'videolist', 'xrd'
    )
